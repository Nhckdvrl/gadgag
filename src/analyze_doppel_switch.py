...
def main():
 ...
 d=pd.DataFrame(rows);b=d[d.condition=='base'][['fold','id','candidate_bias','sense_switch','margin_zh_for_ja','margin_ja_for_ja']].rename(columns={'candidate_bias':'b0','sense_switch':'s0','margin_zh_for_ja':'mz0','margin_ja_for_ja':'mj0'});q=d[d.condition!='base'].merge(b,on=['fold','id']);q['dbias']=q.candidate_bias-q.b0;q['dswitch']=q.sense_switch-q.s0;q['d_margin_zh']=q.margin_zh_for_ja-q.mz0;q['d_margin_ja']=q.margin_ja_for_ja-q.mj0;out=[]
 for c,g in q.groupby('condition'):
  for m in ['dbias','dswitch','d_margin_zh','d_margin_ja']:
